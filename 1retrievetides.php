 ...
 *   If you have a valid php environment (with an installed php version 7.4, php7.4-curl, curl)  all you need to do is put your apikey into the script, cd to an empty directory and run in bash terminal
 *
